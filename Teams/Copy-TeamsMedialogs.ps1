# Author: Andrés Gorzelany
   ...
   <# 
    ...
    .DESCRIPTION
        Find Teams Media logs, zip them and send them using local Outlook
    .PARAMETER emailTo
        The destination e-mail address where to send media logs
    .EXAMPLE
        Send-TeamsMediaLogs.ps1 -emailTo john@contoso.com -emailSubject "Teams Media Logs of John"
    #>
...
try{
    Write-Host "Copy-TeamsMedialogs.ps1 Build "$BuildVersion -ForegroundColor Blue -BackgroundColor Red
    Main
}
catch {
